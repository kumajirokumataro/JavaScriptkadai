...
$(document).ready(function () {
  ...
  function score_indicate() {
    ...
    let subject_points = [Number($('#national_language').val()),//[Number($('#national_language').val())は配列ということはわかった
    Number($('#english').val()),  //「val()」は、HTMLタグ内に記述されているvalue属性を取得したり変更することができるメソッド
    Number($('#mathematics').val()),//Number()は、文字列を数値に変更しているっぽい
    Number($('#science').val()),
    Number($('#society').val())
    ];
